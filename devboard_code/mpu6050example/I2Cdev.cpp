...
I2Cdev::I2Cdev(): i2c(I2C_SDA,I2C_SCL), debugSerial(SERIAL_TX, SERIAL_RX)
{

}

//I2Cdev::I2Cdev(PinName i2cSda, PinName i2cScl): debugSerial(USBTX, USBRX), i2c(i2cSda,i2cScl)
I2Cdev::I2Cdev(PinName i2cSda, PinName i2cScl): i2c(i2cSda,i2cScl), debugSerial(SERIAL_TX, SERIAL_RX)
{
